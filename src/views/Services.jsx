...
const Services = () => {
  ...
  return (
    <>
      <section
        className="pt-20 pb-20 md:pt-30 px-4 md:px-12 text-center min-h-screen flex flex-col justify-center bg-gradient-to-b from-yellow-50 via-amber-50 to-yellow-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800"
      >
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-amber-900 dark:text-amber-400 mt-4 lg:mt-2 lg:pb-2 mb-10">
          Our Services
        </h1>
        ...
        <div className="mb-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="text-amber-800 dark:text-amber-300 mb-4">{service.description}</p>
              <ul className="text-amber-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <div className="flex gap-4 mt-6">
                ...
                <button
                  ...
                  className="flex-1 bg-amber-500 text-white px-4 py-2 rounded-lg text-center hover:bg-amber-700 dark:bg-amber-600 dark:hover:bg-amber-800 transition font-medium shadow-sm"
                >
                  Book Now
                </button>
              </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
