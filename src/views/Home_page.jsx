        ...
        <div className="p-6 rounded-xl max-w-6xl flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 flex justify-center mt-12 sm:mt-12 lg:mt-10">
            <img
              src={image}
              alt="Camera"
              className="w-64 sm:w-80 lg:w-96 rounded-xl shadow-md dark:shadow-gray-700"
            />
          </div>

          {/* Text Section */}
          <div className="lg:w-1/2 w-full text-center lg:text-left">
            <h1 className="pb-6 font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-amber-800 dark:text-amber-400 lg:mt-12 lg:pt-10 leading-tight">
              Capturing moments today, <br /> creating memories for tomorrow.
            </h1>

            <h3 className="font-body text-base sm:text-lg md:text-xl lg:text-2xl text-amber-700 dark:text-amber-300 mb-8 font-bold">
            ...
            */}
            ...
            <div className="flex flex-col md:flex-row justify-center lg:justify-start items-center gap-12 mt-6">
              <div className="text-center">
                <div className="text-5xl font-bold text-amber-800 dark:text-amber-400">500+</div>
                <div className="text-xl font-medium text-amber-700 dark:text-amber-300">
                  Happy Clients
                </div>
              </div>

              <div className="text-center">
                <div className="text-5xl font-bold text-amber-800 dark:text-amber-400">15+</div>
                <div className="text-xl font-medium text-amber-700 dark:text-amber-300">
                  Years Experience
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="text-5xl font-bold text-amber-800 dark:text-amber-400">200+</div>
                <div className="text-xl font-medium text-amber-700 dark:text-amber-300">
                  Projects Done
                </div>
              </div>
