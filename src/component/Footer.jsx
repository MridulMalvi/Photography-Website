...
const Footer = ({ handleNavClick }) => {
  return (
    <footer className="bg-yellow-900 dark:bg-gray-950 text-white pb-6 px-4 md:px-12 rounded-t-sm shadow-inner pt-5 transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 border-b border-yellow-700 dark:border-gray-700 pb-10">
        ...
        <div>
          <div
            className="flex text-yellow-100 dark:text-gray-200 items-center gap-2 text-2xl font-bold mb-4 lg:pt-3 cursor-pointer"
            onClick={() => handleNavClick("/")}
          >
            <Camera className="text-yellow-200 dark:text-yellow-400" />
            Raj Photo Studio
          </div>
        ...
        <div className="lg:px-12 lg:ml-5 mt-3">
          <h3 className="text-lg font-semibold mb-4 text-yellow-400 dark:text-yellow-300">
            Quick Links
          </h3>
          <ul className="space-y-3">
            <li>
              <button
                onClick={() => handleNavClick("/")}
                className="text-sm hover:text-yellow-400 dark:hover:text-yellow-300 transition text-left w-auto"
              >
                Home
              </button>
            </li>
        ...
        {/* Column 3: Services */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-yellow-400 dark:text-yellow-300 sm:pt-4">
            Our Expertise
          </h3>
          <ul className="space-y-3">
            <li>
              <button
                onClick={() => handleNavClick("/services")}
                className="text-sm hover:text-yellow-100 dark:hover:text-yellow-200 transition text-left w-auto"
              >
                Wedding Photography
              </button>
            </li>
